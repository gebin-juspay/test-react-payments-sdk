...
import TesetSDKReact, { HyperFragmentView } from 'test-react-payments-sdk';
      ...
      <View style={styles.containerNew}>
        ...
        <CustomButton2
          ...
          onPress={() => {
            ...
            TesetSDKReact.process(JSON.stringify(payload));
          }}
        />
      </View>
    );
              ...
              <View>
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    ...
                    TesetSDKReact.processWithActivity(JSON.stringify(payload));
                  }}
                /> */}
          ...
          {/* <View style={styles.containerSon2}>
            <CustomButton3
              ...
              onPress={() => {
                ...
                TesetSDKReact.process(JSON.stringify(data));
              }}
            />
          </View> */}
        </View>
