...
Pod::Spec.new do |s|
  s.name         = "test-react-payments-sdk"
  ...
  s.source       = { :git => "https://github.com/juspay/test-react-payments-sdk.git", :tag => "v#{s.version}" }

  s.static_framework = true
  s.source_files = "ios/**/*.{h,m,mm,swift}"

  s.dependency "React-Core"
  s.dependency "TesetPaymentServices", hyper_sdk_version
end
